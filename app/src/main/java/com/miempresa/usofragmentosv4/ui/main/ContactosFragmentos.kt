 ...
 * Use the [ContactosFragmentos.newInstance] factory method to
 * create an instance of this fragment.
 */
class ContactosFragmentos : Fragment() {
    ...
    override fun onCreateView(
        ...
        //return inflater.inflate(R.layout.fragment_contactos_fragmentos, container, false)

        var view:View = inflater.inflate(R.layout.fragment_contactos_fragmentos , container , false)
    ...
    companion object {
         ...
         * @return A new instance of fragment ContactosFragmentos.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ContactosFragmentos().apply {
