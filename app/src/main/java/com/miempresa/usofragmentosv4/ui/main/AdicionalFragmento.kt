...
class AdicionalFragmento : Fragment() {
    ...
    override fun onCreateView(
        ...
        //return inflater.inflate(R.layout.fragment_adicional_fragmento, container, false)
        ...
        btnOperaciones.setOnClickListener( View.OnClickListener{
            val ingresovalores = IngresoValores()
            val transaccion : FragmentTransaction =
                requireActivity().supportFragmentManager.beginTransaction()
            transaccion.replace(R.id.contenedor1, ingresovalores)
            transaccion.commit()
        })
